...
#define CX3_UVC_SOCKET_COUNT                    (2)                         /* Socket Count for Manual Many to One
                                                                               DMA Channel */
...
#define CX3_UVC_VS_PROBE_CONTROL                (0x0100)           /* Control selector for VS_PROBE_CONTROL. */  
#define CX3_UVC_VS_COMMIT_CONTROL               (0x0200)           /* Control selector for VS_COMMIT_CONTROL. */
#define CX3_UVC_VS_STILL_PROBE_CONTROL          (0x0300)           /* Control selector for VS_STILL_PROBE_CONTROL. */  
#define CX3_UVC_VS_STILL_COMMIT_CONTROL         (0x0400)           /* Control selector for VS_STILL_COMMIT_CONTROL. */
#define CX3_UVC_VS_STILL_IMAGE_TRIGGER_CONTROL  (0x0500)           /* Control selector for VS_STILL_IMAGE_TRIGGER_CONTROL. */
...
extern const uint8_t gl720PProbeCtrl[CX3_UVC_MAX_PROBE_SETTING];        /* 1280 x 720 @30.0 fps settings. */
